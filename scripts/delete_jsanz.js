...
async function deleteUser() {
  try {
    const userId = 'c25c9cfc-b68c-4592-a790-57be4611c1a5';
    ...
    if (data && data.length > 0) {
      console.log('User jsanz deleted successfully:', JSON.stringify(data[0], null, 2));
    } else {
      console.log('User jsanz not found or already deleted.');
    }
  } catch (err) {
